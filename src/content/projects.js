...
export const PROJECTS = [
  {
    ...
    longDesc:
      'Built KasiJobs as a mobile-first marketplace web app for small jobs and earning opportunities in Malaysia. The product combines onboarding, task discovery, proof submission, admin review, lightweight job flows, participant messaging, referral operations, and reward tracking in a single full-stack experience.',
    outcome:
  ...
  },
  {
    ...
    longDesc:
      'Designed and implemented a full-funnel acquisition, capture, and retention system for Yello Skincare to reduce marketplace dependence and build an owned marketing engine. The system connected QR-based customer capture, a personalized skincare quiz, automated WhatsApp follow-up, CRM visibility, and website-led retention infrastructure.',
    outcome:
