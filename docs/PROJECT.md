...
## Next Priority
Verify the existing Netlify site is serving this portfolio correctly, then finish the publish-readiness pass by adding CI and a short manual QA checklist.
